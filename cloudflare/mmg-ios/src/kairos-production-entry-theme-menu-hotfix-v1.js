...
const BUILD = "kairos-production-entry-all-theme-navigation-20260719-1";
  ...
  async fetch(request, env, ctx) {
    try {
      ...
      return json({
        ...
        error: {
          code: error?.code || "all_theme_navigation_entry_failed",
          message: error instanceof Error ? error.message : "All-theme navigation publication failed."
        }
...
function stamp(response) {
  ...
  headers.set("X-MMG-All-Theme-Entry", BUILD);
