...
export const KAIROS_REVENUE_PRODUCT_STORE_BUILD = "kairos-revenue-product-store-20260727-1";
...
const ACTION = /^\/api\/kairos\/revenue\/products\/([^/]+)\/(plan-jobs|approve|authorize-job|export)\/?$/i;
...
function builds() { return { engine: KAIROS_REVENUE_ENGINE_BUILD, jobs: KAIROS_REVENUE_PRODUCTION_JOBS_BUILD, store: KAIROS_REVENUE_PRODUCT_STORE_BUILD }; }
