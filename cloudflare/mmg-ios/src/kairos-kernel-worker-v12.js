import kernel from "./kairos-kernel-worker-v11.js";
...
function json(value, status = 200) {
  return new Response(JSON.stringify(value), {
    ...
    headers: {
      ...
      "X-MMG-Runtime": BUILD,
      "X-Kairos-Kernel": "standalone-v12",
