...
for(const marker of["kairos-parent-card-completion-20260715-1","knowledge-library","research-brief","decision-record","doctrine-vault","intelligence-synthesis","/api/hub/run","data-operational-contract","100% operational","RECEIPT_KEY","completed","failed","command-center"])assert.ok(manager.includes(marker),`Knowledge completion contract missing ${marker}`);
...
console.log(JSON.stringify({status:"ready",validator:"kairos-operational-workspaces-20260715-5",workspacesVerified:verified.length,knowledgeParentComplete:true,knowledgeChildrenVerified:5,structuralContracts:true,floatingControls:0},null,2));