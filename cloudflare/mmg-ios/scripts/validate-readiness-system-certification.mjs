...
assert.ok(index.includes("scripts/readiness-system-certification.js?v=recovery-20260714-19"), "Persistent system certification module cache marker is not current.");
