...
const files = {
  ...
  v37: join(root, "src/kairos-production-entry-v37.js"),
...
assert.ok(source.hybrid.includes('./kairos-production-entry-v38.js'));
assert.ok(source.hybrid.includes('kairos-tuesday-shell-enhanced-v38-runtime-20260717-1'));
...
assert.ok(source.v38.includes('./kairos-production-entry-v37.js'));
assert.ok(source.v38.includes('handleChildActionRequest'));
assert.ok(source.v37.includes('handleWeb003CompositeRequest'));
...
console.log(JSON.stringify({
  status: "passed",
  contract: "tuesday-shell-enhanced-v38-runtime",
  ...
  compositeWebsiteProduction: true,
}, null, 2));
