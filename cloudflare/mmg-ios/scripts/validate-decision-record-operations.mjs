...
assert.match(html,/decision-record-operations\.css\?v=recovery-20260714-39/);
assert.match(html,/decision-record-operations\.js\?v=recovery-20260714-39/);
assert.match(html,/kairos-command-hub-recovery-20260714-39/);
