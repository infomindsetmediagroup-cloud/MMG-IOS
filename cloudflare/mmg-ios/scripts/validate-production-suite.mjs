...
const summary={status:failures.length?'failed':'ready',runner:'kairos-production-validation-suite-20260715-95',mode:'operational-command-center',total:scripts.length,passed,failed:failures.length,navigationOwners:1,parentCentersComplete:5,childWorkspacesComplete:25,normalizedChildContracts:true,shopifyAsyncWriteCompletion:true,shopifyJobResultVerification:true,shopifyOperationResultIntegrity:true,shopifyAssetReadback:true,shopifyRenderedStagingVerification:true,shopifyPreviewCookieFlow:true,shopifyDependencyOrderedWrites:true,websiteRetoolStages:5,previewApprovalRequired:true,liveApplicationApprovalRequired:true,backgroundIntervals:0,startupMutationObservers:0,programmaticScrolling:0,failures};
