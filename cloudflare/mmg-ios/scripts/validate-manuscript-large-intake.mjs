...
assert.ok(frontend.includes('manuscript-studio-flow-recovery-20260803-3'), "Flow-recovery Manuscript Studio build is missing.");
...
assert.ok(index.includes('legacy-runtime-loader.js?v=five-center-manuscript-flow-recovery-20260803-3'), "The flow-recovery command runtime loader marker is missing.");
assert.ok(index.includes('manuscript-production-flow-bootstrap.js?v=manuscript-flow-recovery-20260803-3'), "The flow-recovery production bootstrap marker is missing.");
assert.ok(index.includes('manuscript-post-intake-guard.js?v=five-center-manuscript-flow-recovery-20260803-3'), "The post-intake guard marker is missing.");
...
assert.ok(loader.includes('const BUILD = "kairos-five-center-runtime-loader-20260803-4-flow-recovery"'), "The flow-recovery command runtime build is missing.");
assert.ok(loader.includes('const RELEASE = "five-center-dashboard-restored-20260803-3"'), "The command runtime compatibility release is missing.");
assert.ok(loader.includes('const ASSET_RELEASE = "five-center-manuscript-flow-recovery-20260803-3"'), "The flow-recovery asset release is missing.");
...
assert.ok(activeScripts.includes('"manuscript-pipeline-orchestrator.js"'), "The manuscript pipeline orchestrator is missing from the governed runtime.");
assert.ok(activeScripts.includes('"manuscript-continuation-controller.js"'), "The manuscript continuation controller is missing from the governed runtime.");
assert.ok(activeScripts.includes('"manuscript-stage-handoff-controller.js"'), "The manuscript stage handoff controller is missing from the governed runtime.");
...
assert.ok(productionBootstrap.includes('five-center-manuscript-flow-recovery-20260803-3'), "The production bootstrap does not use the flow-recovery command asset release.");
assert.ok(productionBootstrap.includes('manuscript-flow-recovery-20260803-3'), "The production bootstrap does not use the flow-recovery controller release.");
