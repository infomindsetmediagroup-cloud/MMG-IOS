...
for (const flag of [
  ...
  "homepageEmbeddedTemplateMarkupFallbackRequired", "homepageLiteralLiquidTextFallbackRequired",
  ...
  "homepageLiquidMarkupSignaturePreservationRequired", "homepageLiquidTextNodeDistributionPreservationRequired",
...
requireAll(sources.entry, [
  ...
  './kairos-homepage-liquid-text-fallback-v1.js', './kairos-homepage-instance-liquid-fallback-v1.js',
  'kairos-production-entry-20260717-100', 'homepage_liquid_scope_unsafe',
  'published-main-homepage-instance-liquid-text-v1', 'homepage-instance-clone',
