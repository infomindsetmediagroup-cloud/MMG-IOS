...
- Before production promotion, deployment must validate the bundle, root HTTP response, Tuesday HTML marker, and production readback.

Permanent rollback branch: `locked/tuesday-loading-baseline-20260714`.
Experimental deeper runtime branch: `experimental/tuesday-shell-v38-runtime-20260717`.
